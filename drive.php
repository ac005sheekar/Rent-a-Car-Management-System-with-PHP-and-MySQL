...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" 
  ...
  <br>
  <b>Driver_Contact:<b><br>
  <input type="text" name="Driver_Contact" value=" ">
<br>
...
$sql = "INSERT INTO tbl_driver (Driver_Id, Driver_Contact) VALUES('$Driver_Id','$Driver_Contact')";
...
header("refresh:4;url=driver.php");
?>
